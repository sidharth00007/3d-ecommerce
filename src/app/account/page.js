                ...
                <div className="bg-white shadow">
                    <div className="p-6 sm:p-12">
                        ...
                        <button
                            ...
                            className="mt-5  rounded-md inline-block bg-black text-white px-5 py-3 text-xs font-medium uppercase tracking-wide">
                            View Your Orders
                        </button>
                        <div className="mt-6">
                                        ...
                                        addresses.map((item) => (
                                            <div className="border p-6" key={item._id}>
                                                ...
                                                <button
                                                    ...
                                                    className="mt-5 mr-5 rounded-md inline-block bg-black text-white px-5 py-3 text-xs font-medium uppercase tracking-wide"
                                                >
                                                    Update
                                                </button>
                                                <button
                                                    onClick={() => handleDelete(item._id)}
                                                    className="mt-5  inline-block rounded-md bg-black text-white px-5 py-3 text-xs font-medium uppercase tracking-wide"
                                                >
                                                    {componentLevelLoader &&
