        ...
        <div className="lg:col-gap-12 xl:col-gap-16 mt-8 grid grid-cols-1 gap-12 lg:mt-12 lg:grid-cols-5 lg:gap-16">
          {/* <div className="lg:col-span-3 lg:row-end-1"> */}
            <div className="lg:flex lg:items-start">
              <div className="lg:order-2 lg:mr-60">
                <div className="h-400 w-600 " >
                    ...
                    height="500px"
                    width="400px"
                      src="https://my.spline.design/untitled-35925ce48111ca977b161936ef1d9bde/"
                    > </iframe> */}
                </div>
              </div>
          ...
          <div className="lg:col-span-2 lg:row-span-2 lg:row-end-2">
            ...
            <div className="mt-10 flex flex-col items-center justify-between space-y-4 botder-t border-b py-4 sm:flex-row sm:space-y-0">
              <div className="flex items-end">
                ...
                {item.onSale === "yes" ? (
                  <h1 className="text-3xl font-bold text-red-700">{` ₹${Math.round(
